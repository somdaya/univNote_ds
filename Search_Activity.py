...
def activity_list_search(keyword='',start_index=0) : # 대외활동 검색 함수
...
if __name__ == "__main__" :
    ...
    activity_list_search(keyword=keyword) # 처음 10개 가져오는 함수
    activity_list_search(keyword=keyword, start_index=10) # 11~20개 가져오는 함수
